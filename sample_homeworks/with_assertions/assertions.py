hidden_assertions = {1: """assert verbose(123) == 'հարյուր քսաներեք'
...
assert verbose(78) == 'յոթանասունութ'""",
...
assert email_to_username('s@.com') == 's'""",
