...
def convert2script(notebook_path, script_name):
    convert(input_path=notebook_path, output_path=script_name)
    script_path = os.path.join(os.path.dirname(notebook_path), f'{script_name}.py')
    cleanup(path=script_path)
